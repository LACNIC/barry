...
check_output_contains "notification-1" -Fx \
	...
	"https://localhost:8443/rrdp/notification-1.xml,snapshot.uri,C String,https://localhost:8443/rrdp/snapshot.xml" \
	"https://localhost:8443/rrdp/notification-1.xml,snapshot.path,C String,snapshot.xml" \
...
check_output_contains "notification-2" -Fx \
	...
	"https://localhost:8443/rrdp/notification-2.xml,snapshot.uri,C String,https://localhost:8443/rrdp/snapshot-2.xml" \
	"https://localhost:8443/rrdp/notification-2.xml,snapshot.path,C String,achoo.xml" \
